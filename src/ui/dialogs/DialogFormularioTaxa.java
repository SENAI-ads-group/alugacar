...
import ui.panels.formularios.FormularioTaxa;
 ...
 */
public class DialogFormularioTaxa extends javax.swing.JDialog {
    ...
    public DialogFormularioTaxa(java.awt.Frame parent, boolean modal, Taxa taxa) {
        super(parent, modal);
        this.taxa = taxa;
        initComponents();
        carregarPaineis();
