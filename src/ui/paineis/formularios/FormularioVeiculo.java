...
public final class FormularioVeiculo extends javax.swing.JPanel {
    ...
    public Veiculo getFormData() throws ValidacaoException {
        ValidacaoException exception = new ValidacaoException("Veiculo");
        if (formattedTextFieldPlaca.getText().replace(" ", "").length() != 8) {
            exception.addError("placa", "Placa inválida");
        }
        if (textFieldRenavam.getText().length() != 11) {
        ...
        if (comboBoxModelo.getSelectedItem()
                == null) {
    ...
    private void initComponents() {
        ...
        labelErroPlaca.setMaximumSize(new java.awt.Dimension(190, 15));
        labelErroPlaca.setMinimumSize(new java.awt.Dimension(190, 15));
        ...
        labelErroMarca.setMaximumSize(new java.awt.Dimension(190, 15));
        labelErroMarca.setMinimumSize(new java.awt.Dimension(190, 15));
        ...
        labelErroRenavam.setMaximumSize(new java.awt.Dimension(190, 15));
        labelErroRenavam.setMinimumSize(new java.awt.Dimension(190, 15));
        labelErroRenavam.setPreferredSize(new java.awt.Dimension(190, 15));
        add(labelErroRenavam, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 45, -1, -1));

        labelErroKMAtual.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        labelErroKMAtual.setForeground(java.awt.Color.red);
        labelErroKMAtual.setMaximumSize(new java.awt.Dimension(190, 15));
        labelErroKMAtual.setMinimumSize(new java.awt.Dimension(190, 15));
        ...
        add(labelAnoFabricacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, -1, -1));
        ...
        add(yearChooserFabricacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, -1, -1));
        ...
        labelErroAnoFabricacao.setMaximumSize(new java.awt.Dimension(190, 15));
        labelErroAnoFabricacao.setMinimumSize(new java.awt.Dimension(190, 15));
        labelErroAnoFabricacao.setPreferredSize(new java.awt.Dimension(190, 15));
        add(labelErroAnoFabricacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 105, -1, -1));
        ...
        labelErroModelo.setMaximumSize(new java.awt.Dimension(190, 15));
        labelErroModelo.setMinimumSize(new java.awt.Dimension(190, 15));
        labelErroModelo.setPreferredSize(new java.awt.Dimension(190, 15));
        add(labelErroModelo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 165, -1, -1));
        ...
        textFieldRenavam.setPreferredSize(new java.awt.Dimension(190, 25));
        add(textFieldRenavam, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, -1, -1));
        FieldUtilities.setFieldOnlyInteger(textFieldRenavam, 11);
