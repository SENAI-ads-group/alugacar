...
import ui.paineis.formularios.FormularioItemChecklist;
 ...
 */
public class DialogChecklist extends javax.swing.JDialog {
    ...
    public DialogChecklist(java.awt.Frame parent, boolean modal, ItemVistoria item) {
        super(parent, modal);
        this.item = item;
        initComponents();
        carregarPaineis();
