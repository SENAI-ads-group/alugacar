...
import ui.paineis.formularios.FormularioDesconto;
...
public class DialogDesconto extends javax.swing.JDialog {
    ...
    public DialogDesconto(java.awt.Frame parent, boolean modal, Desconto desconto) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        tabbedPane.addTab("Desconto", new javax.swing.ImageIcon(getClass().getResource("/ui/media/icons/icon-desconto-24x24.png")), panelTab1, "Informações pessoais básicas do motorista"); // NOI18N
        ...
        getAccessibleContext().setAccessibleName("Formulário de desconto");
