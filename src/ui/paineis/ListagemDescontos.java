...
import ui.dialogs.DialogDesconto;
 ...
 */
public final class ListagemDescontos extends javax.swing.JPanel implements DataChangeListener {
    ...
    public void atualizarListagem() {
        List<Desconto> descontos = DAO.buscarTodos();
    ...
    public void exibirFormulario(Desconto desconto) throws DBException {
        DialogDesconto dialog = new DialogDesconto(FrameLoader.getFrameMain(), true, desconto);
    ...
    private void initComponents() {
        ...
        labelTitleList.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/media/icons/icon-desconto-28x28.png"))); // NOI18N
        labelTitleList.setText("Descontos de locação");
