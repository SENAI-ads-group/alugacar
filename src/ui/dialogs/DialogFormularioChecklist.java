...
import ui.panels.formularios.FormularioItemChecklist;
 ...
 */
public class DialogFormularioChecklist extends javax.swing.JDialog {

    private ItemVistoria item;
    private final ItemVistoriaDAO DAO = DAOFactory.createItemVistoriaDAO();

    private FormularioItemChecklist formulario;

    private final List<DataChangeListener> listeners = new ArrayList<>();

    public DialogFormularioChecklist(java.awt.Frame parent, boolean modal, ItemVistoria item) {
        super(parent, modal);
        this.item = item;
        initComponents();
        carregarPaineis();
    ...
    private void carregarPaineis() {
        formulario = new FormularioItemChecklist(item);
    ...
    public ItemVistoria getDadosFormulario() throws ValidacaoException {
        item = formulario.getDadosFormulario();
        return item;
    }
    ...
    private void buttonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConfirmarActionPerformed
        try {
            ...
            if (ex.getMessage().equals("ItemChecklist")) {
