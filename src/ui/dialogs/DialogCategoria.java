...
import ui.paineis.formularios.FormularioCategoria;
...
public class DialogCategoria extends javax.swing.JDialog {
    ...
    public DialogCategoria(java.awt.Frame parent, boolean modal, Categoria categoria) {
        super(parent, modal);
    ...
    private void buttonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConfirmarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, ex.getMessage(), "Erro ao persistir categoria", JOptionPane.ERROR_MESSAGE);
        }
