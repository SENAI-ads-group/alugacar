...
import ui.dialogs.DialogVeiculo;
 ...
 */
public final class ListagemVeiculos extends javax.swing.JPanel implements DataChangeListener {
    ...
    public void atualizarListagem(List<Veiculo> veiculos) {
    ...
    public void criarFormulario(Veiculo veiculo) {
        DialogVeiculo dialogForm = new DialogVeiculo(FrameLoader.getFrameMain(), true, veiculo);
    ...
    private void buttonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonNovoActionPerformed
        criarFormulario(new Veiculo());
    }//GEN-LAST:event_buttonNovoActionPerformed

    private void buttonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditarActionPerformed
        int linhaSelecionada = table.getSelectedRow();
        Integer idSelecionado = Utilities.tryParseToInteger(table.getValueAt(linhaSelecionada, 0).toString());
        criarFormulario(DAO.buscar(idSelecionado));
        table.getSelectionModel().setSelectionInterval(linhaSelecionada, linhaSelecionada);
    ...
    private void buttonDisponibilizarIndisponibilizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDisponibilizarIndisponibilizarActionPerformed
        ...
        switch (veiculoSelecionado.getStatusVeiculo()) {
            case DISPONIVEL:
